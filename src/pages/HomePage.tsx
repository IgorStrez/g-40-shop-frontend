...
const HomePage = () => {
  return (
    <Container className="mt-5">
      <Row>
        <Col>
          <h1 className="text-center mb-4">Добро пожаловать в Мистический Магазин Мавроди!</h1>
          <p className="text-center">Добро пожаловать в наш магазин Книг и Сувениров, наполненные Тайной и Мистикой. У нас вы найдете уникальные товары, связанные с наследием Сергея Мавроди.</p>
        </Col>
      </Row>
      <Row className="mt-5">
        <Col md={4}>
